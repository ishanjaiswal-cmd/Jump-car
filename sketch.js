...
function preload(){
  trex_running =   loadImage("cr.png");
  trex_collided = loadImage("cr.png");
  
  groundImage = loadImage("r.png");
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(keyDown("right_arrow") && trex.y >= 159) {
      trex.velocityX= 15;
    }
    ...
    if(keyDown("left_arrow") && trex.y >= 159) {
      trex.velocityX = -15;
    }
